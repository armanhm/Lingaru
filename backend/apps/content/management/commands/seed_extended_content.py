...
class Command(BaseCommand):
    ...
    def _seed_topic_9(self):
        ...
        l1 = Lesson.objects.create(
            ...
            order=1,
            difficulty=1,
            content={"intro": "Learn the words for family members in French."},
        )
        self._bulk_vocab(
            l1,
            [
                ...
                (
                    ...
                    "daughter",
                    "la fij",
                    "Leur fille est très intelligente.",
                    "f",
                    "noun",
                ),
        ...
        GrammarRule.objects.create(
            ...
            examples=[
                ...
                "Leurs parents sont professeurs.",
            ],
            exceptions=[
                "Use mon/ton/son before feminine nouns starting with a vowel sound: mon école, ton amie, son histoire."
            ],
        )
        l3 = Lesson.objects.create(
            topic=t, type="text", title="Une famille française", order=3, difficulty=1, content={}
        )
        ReadingText.objects.create(
            lesson=l3,
            title="Présentation de famille",
            ...
            comprehension_questions=[
                ...
                },
                {
                    ...
                    "answer": "In the countryside (à la campagne).",
                },
            ],
        )
        self._bulk_questions(
            ...
            [
                (
                    ...
                    "la grand-mère",
                    ["le grand-père", "la mère", "la tante"],
                    "Grand-mère means grandmother.",
                    1,
                ),
                (
                    "translate",
                    "Translate: 'My sister studies music.'",
                    "Ma sœur étudie la musique.",
                    [],
                    "Use 'Ma' for feminine noun sœur.",
                    1,
                ),
                (
                    "fill_blank",
                    "Mon ___ s'appelle Thomas. (brother)",
                    "frère",
                    ["père", "oncle", "fils"],
                    "Frère = brother.",
                    1,
                ...
                (
                    "mcq",
                    "Which possessive adjective is used for 'my' before a feminine noun?",
                    "ma",
                    ["mon", "mes", "sa"],
                    "Ma is used before feminine singular nouns.",
                    1,
                ),
            ],
        )
    ...
    def _seed_topic_10(self):
        ...
        l1 = Lesson.objects.create(
            ...
            order=1,
            difficulty=2,
            content={"intro": "Learn words about nature and the environment."},
        )
        self._bulk_vocab(
            l1,
            [
                ...
                (
                    ...
                    "ocean",
                    "lɔ.se.ɑ̃",
                    "L'océan Atlantique est très profond.",
                    "m",
                    "noun",
                ),
                (
                ...
                (
                    ...
                    "beach",
                    "la plaʒ",
                    "Nous passons nos vacances à la plage.",
                    "f",
                    "noun",
                ),
                ...
                (
                    ...
                    "to recycle",
                    "ʁe.si.kle",
                    "Il faut recycler le papier et le verre.",
                    "a",
                    "verb",
                ),
                (
                    ...
                    "pollution",
                    "la pɔ.ly.sjɔ̃",
                    "La pollution de l'air est dangereuse.",
                    "f",
                    "noun",
                ),
                (
        ...
        GrammarRule.objects.create(
            lesson=l2,
            title="Present Participle (le gérondif)",
            ...
            examples=[
                "En regardant par la fenêtre, il a vu un cerf.",
                "Elle apprend le français en écoutant des podcasts.",
                "En recyclant, on protège la planète.",
                "Je me suis blessé en courant.",
            ],
            exceptions=["Irregular: être → étant, avoir → ayant, savoir → sachant"],
        )
        l3 = Lesson.objects.create(
            topic=t, type="text", title="Protéger la nature", order=3, difficulty=2, content={}
        )
        ReadingText.objects.create(
            lesson=l3,
            title="Un monde plus vert",
            ...
            comprehension_questions=[
                {
                    "question": "Name three everyday actions mentioned to help the environment.",
                    "answer": "Recycling, using public transport, eating less meat (or planting trees).",
                },
                {
                    "question": "What does global warming threaten?",
                    "answer": "Forests, oceans, and thousands of animal species.",
                },
            ],
        )
        self._bulk_questions(
            ...
            [
                (
                    "mcq",
                    "What is 'la forêt' in English?",
                    "forest",
                    ["mountain", "beach", "desert"],
                    "La forêt = forest.",
                    1,
                ),
                (
                    "translate",
                    "Translate: 'Global warming is a worldwide problem.'",
                    "Le réchauffement climatique est un problème mondial.",
                    [],
                    "Use le réchauffement climatique.",
                    2,
                ),
                (
                    "fill_blank",
                    "Il faut ___ le papier et le verre. (recycle)",
                    "recycler",
                    ["polluer", "acheter", "oublier"],
                    "Recycler = to recycle.",
                    2,
                ),
                (
                    ...
                    "nous form minus -ons + -ant",
                    ["infinitive + -ant", "past participle + -ant", "vous form + -ant"],
                    "Remove -ons from nous form and add -ant.",
                    2,
                ),
            ],
        )
    ...
    def _seed_topic_11(self):
        ...
        t = Topic.objects.create(
            name_fr=name_fr,
            name_en="Technology & Digital Life",
        ...
        l1 = Lesson.objects.create(
            ...
            order=1,
            difficulty=2,
            content={"intro": "Essential tech vocab in French."},
        )
        self._bulk_vocab(
            l1,
            [
                ...
                (
                    ...
                    "to send an email",
                    "ɑ̃.vwa.je œ̃ i.mɛl",
                    "Je t'ai envoyé un e-mail ce matin.",
                    "a",
                    "verb",
                ),
                (
                    ...
                    "social networks",
                    "le ʁe.zo sɔ.sjo",
                    "Les réseaux sociaux sont très populaires.",
                    "m",
                    "noun",
                ),
                (
                ...
                (
                    ...
                    "cloud",
                    "lə nɥaʒ",
                    "Je sauvegarde mes fichiers dans le nuage.",
                    "m",
                    "noun",
                ),
                ...
                (
                    ...
                    "app",
                    "la.pli.ka.sjɔ̃",
                    "Cette application est très utile.",
                    "f",
                    "noun",
                ),
                ...
                (
                    "la cybersécurité",
                    "cybersecurity",
                    "la si.bɛʁ.se.ky.ʁi.te",
                    "La cybersécurité est cruciale pour les entreprises.",
                    "f",
                    "noun",
                ),
            ],
        ...
        l2 = Lesson.objects.create(
            topic=t, type="grammar", title="The Future Tense", order=2, difficulty=2, content={}
        )
        GrammarRule.objects.create(
            lesson=l2,
            ...
            examples=[
                "Demain, je travaillerai de chez moi.",
                "La technologie changera notre façon de vivre.",
                "Ils achèteront un nouvel ordinateur.",
                "Nous parlerons au directeur vendredi.",
            ],
            exceptions=[
                "Common irregular stems: être→ser-, avoir→aur-, aller→ir-, faire→fer-, pouvoir→pourr-, vouloir→voudr-, venir→viendr-"
            ],
        )
        l3 = Lesson.objects.create(
            topic=t, type="text", title="La vie numérique", order=3, difficulty=2, content={}
        )
        ReadingText.objects.create(
            lesson=l3,
            title="Notre quotidien connecté",
            ...
            comprehension_questions=[
                {
                    "question": "What do people check first thing in the morning?",
                    "answer": "Their phones for news and social media.",
                },
                {
                    "question": "Why is it important to disconnect sometimes?",
                    "answer": "To protect mental health.",
                },
            ],
        )
        self._bulk_questions(
            ...
            [
                (
                    "mcq",
                    "How do you say 'to download' in French?",
                    "télécharger",
                    ["brancher", "pirater", "envoyer"],
                    "Télécharger = to download.",
                    1,
                ),
                (
                    "translate",
                    "Translate: 'My phone battery is dead.'",
                    "La batterie de mon téléphone est déchargée.",
                    [],
                    "Use batterie and déchargée.",
                    2,
                ),
                (
                    "mcq",
                    "Which future stem is used for 'être'?",
                    "ser-",
                    ["êtr-", "est-", "ét-"],
                    "Être has the irregular future stem ser-.",
                    2,
                ),
                (
                    "fill_blank",
                    "Demain, je ___ de chez moi. (travailler, futur)",
                    "travaillerai",
                    ["travaille", "travaillais", "travaillé"],
                    "Future of travailler = travaillerai.",
                    2,
                ),
            ],
        )
    ...
    def _seed_topic_12(self):
        ...
        l1 = Lesson.objects.create(
            ...
            order=1,
            difficulty=1,
            content={"intro": "Words to express your feelings in French."},
        )
        self._bulk_vocab(
            l1,
            [
                ...
                (
                    ...
                    "tired",
                    "fa.ti.ɡe",
                    "Je suis fatigué après cette longue journée.",
                    "a",
                    "adjective",
                ),
                (
                ...
                (
                    ...
                    "surprised",
                    "syʁ.pʁi / syʁ.pʁiz",
                    "J'étais très surpris de te voir ici.",
                    "a",
                    "adjective",
                ),
                (
                ...
                (
                    ...
                    "relieved",
                    "su.la.ʒe",
                    "Je suis soulagé que tout aille bien.",
                    "a",
                    "adjective",
                ),
                (
        ...
        l2 = Lesson.objects.create(
            topic=t, type="grammar", title="Adjective Agreement", order=2, difficulty=1, content={}
        )
        GrammarRule.objects.create(
            lesson=l2,
            ...
            examples=[
                ...
                "Ils sont fatigués. Elles sont fatiguées.",
                "Mon frère est fier. Ma sœur est fière.",
                "Les enfants sont contents.",
            ],
            exceptions=["Invariable adjectives (no change): sympa, marron, orange, chic, super"],
        )
        l3 = Lesson.objects.create(
            topic=t, type="text", title="Journal intime", order=3, difficulty=1, content={}
        )
        ReadingText.objects.create(
            lesson=l3,
            title="Les émotions d'une journée",
            ...
            comprehension_questions=[
                {
                    "question": "Why was the writer happy in the morning?",
                    "answer": "She received good news at work.",
                },
                {
        ...
        self._bulk_questions(
            ...
            [
                (
                    "mcq",
                    "How do you say 'I am worried' in French?",
                    "Je suis inquiet/inquiète",
                    ["Je suis triste", "J'ai peur", "Je suis fier"],
                    "Inquiet(e) = worried.",
                    1,
                ),
                (
                    "translate",
                    "Translate: 'She is proud of her son.'",
                    "Elle est fière de son fils.",
                    [],
                    "Fier becomes fière for feminine.",
                    1,
                ),
                (
                    "fill_blank",
                    "Il est très ___ après la longue journée. (tired)",
                    "fatigué",
                    ["heureux", "triste", "jaloux"],
                    "Fatigué = tired (masculine form).",
                    1,
                ),
                (
                    "mcq",
                    "What is the feminine form of 'jaloux'?",
                    "jalouse",
                    ["jalouxe", "jalouse", "jalousse"],
                    "Jaloux → jalouse follows -eux/-euse pattern.",
                    1,
                ),
            ],
        )
    ...
    def _seed_topic_13(self):
        ...
        l1 = Lesson.objects.create(
            ...
            order=1,
            difficulty=1,
            content={"intro": "Essential vocabulary for school and university life."},
        )
        self._bulk_vocab(
            l1,
            [
                (
                    ...
                    "school",
                    "le.kɔl",
                    "Les enfants vont à l'école le lundi.",
                    "f",
                    "noun",
                ),
                (
                ...
                (
                    ...
                    "class/lesson",
                    "lə kuʁ",
                    "Le cours de maths commence à 8h.",
                    "m",
                    "noun",
                ),
                ...
                (
                    ...
                    "teacher/professor",
                    "lə pʁɔ.fɛ.sœʁ",
                    "Notre professeur est très pédagogue.",
                    "m",
                    "noun",
                ),
                (
                ...
                (
                    ...
                    "library",
                    "la bi.bljɔ.tɛk",
                    "Je travaille à la bibliothèque tous les matins.",
                    "f",
                    "noun",
                ),
                (
                    ...
                    "lecture hall",
                    "lɑ̃.fi.te.ɑtʁ",
                    "Le cours a lieu dans un amphithéâtre.",
                    "m",
                    "noun",
                ),
                (
        ...
        GrammarRule.objects.create(
            ...
            examples=[
                ...
                "Elle a dit qu'elle passerait l'examen.",
                "Nous aimerions apprendre le mandarin.",
            ],
            exceptions=[
                "Same irregular stems as futur simple: être→ser-, avoir→aur-, aller→ir-, faire→fer-"
            ],
        )
        l3 = Lesson.objects.create(
            topic=t, type="text", title="La vie étudiante", order=3, difficulty=2, content={}
        )
        ReadingText.objects.create(
            lesson=l3,
            title="Un étudiant à Paris",
            ...
            comprehension_questions=[
                ...
                {
                    "question": "What does his professor advise him to do?",
                    "answer": "Make revision cards (fiches de révision).",
                },
            ],
        )
        self._bulk_questions(
            ...
            [
                (
                    "mcq",
                    "What is 'la bibliothèque' in English?",
                    "library",
                    ["bookstore", "classroom", "office"],
                    "Bibliothèque = library.",
                    1,
                ),
                (
                    "translate",
                    "Translate: 'I would like to study medicine.'",
                    "Je voudrais étudier la médecine.",
                    [],
                    "Use the conditional voudrais.",
                    2,
                ),
                (
                    "fill_blank",
                    "Si j'avais le temps, j'___ plus. (étudier, conditional)",
                    "étudierais",
                    ["étudie", "étudiai", "étudierai"],
                    "Conditional of étudier = étudierais.",
                    2,
                ),
                (
                    "mcq",
                    "What is the conditional used for?",
                    "All of the above",
                    ["Polite requests", "Hypothetical situations", "Reported speech"],
                    "The conditional has multiple uses.",
                    2,
                ),
            ],
        )
    ...
    def _seed_topic_14(self):
        ...
        l1 = Lesson.objects.create(
            topic=t,
            type="vocab",
            title="Sports & Body Vocabulary",
            order=1,
            difficulty=1,
            content={"intro": "Sports and body vocabulary in French."},
        )
        self._bulk_vocab(
            l1,
            [
                (
                    ...
                    "to play football",
                    "ʒwe o fut",
                    "Il joue au foot tous les dimanches.",
                    "a",
                    "verb phrase",
                ),
                ...
                (
                    ...
                    "to run",
                    "ku.ʁiʁ",
                    "Je cours cinq kilomètres chaque matin.",
                    "a",
                    "verb",
                ),
                (
                ...
                (
                    ...
                    "injured",
                    "ble.se",
                    "Le joueur est blessé et ne peut pas jouer.",
                    "a",
                    "adjective",
                ),
                (
                    ...
                    "to train/practise",
                    "sɑ̃.tʁɛ.ne",
                    "L'équipe s'entraîne deux fois par semaine.",
                    "a",
                    "verb",
                ),
                (
                    ...
                    "championship",
                    "lə ʃɑ̃.pjɔ.na",
                    "La France a gagné le championnat du monde.",
                    "m",
                    "noun",
                ),
            ],
        ...
        l2 = Lesson.objects.create(
            topic=t, type="grammar", title="Reflexive Verbs", order=2, difficulty=2, content={}
        )
        GrammarRule.objects.create(
            lesson=l2,
            ...
            examples=[
                ...
                "Elle se douche après le sport.",
                "Nous nous entraînons le samedi.",
                "Il s'est blessé pendant le match.",
                "Tu te couches à quelle heure ?",
            ],
            exceptions=[
                "In compound tenses, the past participle agrees with the subject: Elles se sont levées tôt."
            ],
        )
        l3 = Lesson.objects.create(
            topic=t, type="text", title="Le sport en France", order=3, difficulty=1, content={}
        )
        ReadingText.objects.create(
            lesson=l3,
            title="Les Français et le sport",
            ...
            comprehension_questions=[
                {"question": "What is the most popular sport in France?", "answer": "Football."},
                {
                    ...
                    "answer": "The most famous cycling race in the world.",
                },
            ],
        )
        self._bulk_questions(
            ...
            [
                (
                    "mcq",
                    "How do you say 'to win' in French?",
                    "gagner",
                    ["perdre", "jouer", "courir"],
                    "Gagner = to win.",
                    1,
                ...
                (
                    "translate",
                    "Translate: 'She injured her leg during the match.'",
                    "Elle s'est blessée à la jambe pendant le match.",
                    [],
                    "Use reflexive se blesser in passé composé.",
                    2,
                ),
                (
                    "fill_blank",
                    "Je ___ à sept heures chaque matin. (se lever)",
                    "me lève",
                    ["me levais", "se lève", "nous levons"],
                    "Je me lève = I get up.",
                    1,
                ),
                (
                    "mcq",
                    "What auxiliary verb is used with reflexive verbs in compound tenses?",
                    "être",
                    ["avoir", "faire", "aller"],
    ...
    def _seed_topic_15(self):
        ...
        l1 = Lesson.objects.create(
            ...
            order=1,
            difficulty=1,
            content={"intro": "Describe the weather in French."},
        )
        self._bulk_vocab(
            l1,
            [
                (
                    ...
                    "the weather is nice",
                    "il fɛ bo",
                    "Il fait beau aujourd'hui, allons au parc !",
                    "a",
                    "expression",
                ),
                (
                ...
                (
                    ...
                    "it is snowing",
                    "il nɛʒ",
                    "Il neige en montagne en décembre.",
                    "a",
                    "expression",
                ),
                (
                ...
                (
                    ...
                    "it is cold",
                    "il fɛ fʁwa",
                    "Il fait froid ce soir, mets un manteau.",
                    "a",
                    "expression",
                ),
                ...
                (
                    ...
                    "thunderstorm",
                    "lɔ.ʁaʒ",
                    "Un orage violent a éclaté hier soir.",
                    "m",
                    "noun",
                ),
                ...
                (
                    ...
                    "winter",
                    "li.vɛʁ",
                    "L'hiver est froid dans le nord de la France.",
                    "m",
                    "noun",
                ),
                (
                    ...
                    "temperature",
                    "la tɑ̃.pe.ʁa.tyʁ",
                    "La température monte à 35 degrés en juillet.",
                    "f",
                    "noun",
                ),
            ],
        ...
        GrammarRule.objects.create(
            lesson=l2,
            title="Impersonal Expressions with 'il'",
            ...
            examples=[
                ...
                "Il pleut tous les jours en novembre.",
                "Il faut prendre un parapluie.",
                "Il neige depuis hier matin.",
            ],
            exceptions=[
                "Il y a is used for nouns (du soleil, du vent), while il fait is used with adjectives (beau, chaud)."
            ],
        )
        l3 = Lesson.objects.create(
            topic=t, type="text", title="Les saisons en France", order=3, difficulty=1, content={}
        )
        ReadingText.objects.create(
            lesson=l3,
            ...
            comprehension_questions=[
                ...
                },
                {
                    ...
                    "answer": "There is lots of snow, perfect for skiing.",
                },
            ],
        )
        self._bulk_questions(
            ...
            [
                (
                    "mcq",
                    "How do you say 'it is snowing' in French?",
                    "il neige",
                    ["il pleut", "il fait froid", "il y a du vent"],
                    "Il neige = it is snowing.",
                    1,
                ),
                (
                    "translate",
                    "Translate: 'It is very hot in summer.'",
                    "Il fait très chaud en été.",
                    [],
                    "Use il fait chaud and en été.",
                    1,
                ),
                (
                    "fill_blank",
                    "Il ___ beaucoup de vent aujourd'hui.",
                    "y a",
                    ["fait", "pleut", "neige"],
                ...
                (
                    "mcq",
                    "Which season comes after autumn in French?",
                    "l'hiver",
                    ["le printemps", "l'été", "l'automne"],
                    "Automne → Hiver (winter).",
                    1,
                ),
            ],
        )
    ...
    def _seed_topic_16(self):
        ...
        l1 = Lesson.objects.create(
            ...
            order=1,
            difficulty=1,
            content={"intro": "Vocabulary for rooms, furniture, and household items."},
        )
        self._bulk_vocab(
            l1,
            [
                ...
                (
                    ...
                    "bathroom",
                    "la sal də bɛ̃",
                    "Il y a deux salles de bains dans notre maison.",
                    "f",
                    "noun",
                ),
                ...
                (
                    ...
                    "table",
                    "la tabl",
                    "Mets la table pour le dîner, s'il te plaît.",
                    "f",
                    "noun",
                ),
                ...
                (
                    ...
                    "rent",
                    "lə lwa.je",
                    "Le loyer de cet appartement est élevé.",
                    "m",
                    "noun",
                ),
                (
                ...
                (
                    ...
                    "to move in",
                    "ɑ̃.me.na.ʒe",
                    "Ils ont emménagé dans leur nouvel appartement.",
                    "a",
                    "verb",
                ),
                (
                    ...
                    "landlord/owner",
                    "lə pʁɔ.pʁje.tɛʁ",
                    "Le propriétaire a réparé le chauffage.",
                    "m",
                    "noun",
                ),
                (
        ...
        GrammarRule.objects.create(
            ...
            examples=[
                ...
                "La bibliothèque est en face de la mairie.",
                "Ma chambre est à côté de la salle de bains.",
                "Le supermarché est près du métro.",
                "Les clés sont sur le canapé.",
            ],
            exceptions=["de + le → du: à côté du salon | de + les → des: près des fenêtres"],
        )
        l3 = Lesson.objects.create(
            topic=t, type="text", title="Chercher un appartement", order=3, difficulty=1, content={}
        )
        ReadingText.objects.create(
            lesson=l3,
            ...
            comprehension_questions=[
                ...
                },
                {
                    ...
                    "answer": "Charges (charges comprises).",
                },
            ],
        )
        self._bulk_questions(
            ...
            [
                ...
                (
                    "translate",
                    "Translate: 'The keys are on the sofa.'",
                    "Les clés sont sur le canapé.",
                    [],
                    "Sur = on.",
                    1,
                ...
                (
                    "fill_blank",
                    "Le supermarché est ___ du métro. (near)",
                    "près",
                    ["loin", "devant", "sous"],
                    "Près de = near.",
                    1,
                ...
                (
                    "mcq",
                    "Which contraction is correct: 'near the shops'?",
                    "près des magasins",
                    ["près de les magasins", "près du magasins", "près de magasins"],
                    "de + les = des.",
                    1,
                ),
            ],
    ...
    def _seed_topic_17(self):
        ...
        l1 = Lesson.objects.create(
            topic=t,
            type="vocab",
            title="Arts Vocabulary",
            order=1,
            difficulty=2,
            content={"intro": "Vocabulary for the arts and cultural activities."},
        )
        self._bulk_vocab(
            l1,
            [
                (
                    ...
                    "painting",
                    "lə ta.blo",
                    "Ce tableau est exposé au Louvre.",
                    "m",
                    "noun",
                ),
                ...
                (
                    ...
                    "theatre",
                    "lə te.ɑtʁ",
                    "Il joue dans une pièce de théâtre.",
                    "m",
                    "noun",
                ),
                (
                ...
                (
                    ...
                    "sculpture",
                    "la skyl.tyʁ",
                    "La sculpture de Rodin est célèbre.",
                    "f",
                    "noun",
                ),
                (
                    ...
                    "literature",
                    "la li.te.ʁa.tyʁ",
                    "J'étudie la littérature française au lycée.",
                    "f",
                    "noun",
                ),
                (
                    ...
                    "novel",
                    "lə ʁɔ.mɑ̃",
                    "J'ai lu un roman policier ce week-end.",
                    "m",
                    "noun",
                ),
                (
                    ...
                    "classical music",
                    "la my.zik kla.sik",
                    "Ma grand-mère écoute de la musique classique.",
                    "f",
                    "noun",
                ),
                (
                    ...
                    "exhibition",
                    "lɛks.po.zi.sjɔ̃",
                    "Il y a une belle exposition au Centre Pompidou.",
                    "f",
                    "noun",
                ),
                (
                ...
                (
                    ...
                    "to criticise",
                    "kʁi.ti.ke",
                    "Les journalistes ont critiqué le film.",
                    "a",
                    "verb",
                ),
                (
                ...
                (
                    ...
                    "heritage",
                    "lə pa.tʁi.mwan",
                    "Le patrimoine culturel français est immense.",
                    "m",
                    "noun",
                ),
            ],
        ...
        l2 = Lesson.objects.create(
            topic=t, type="grammar", title="Relative Pronouns", order=2, difficulty=3, content={}
        )
        GrammarRule.objects.create(
            lesson=l2,
            ...
            examples=[
                ...
                "L'artiste qui expose ici est très connu.",
                "C'est le film dont tout le monde parle.",
                "Voici le théâtre où nous avons vu Molière.",
                "La peinture dont j'ai besoin est très chère.",
            ],
            exceptions=["Que becomes qu' before a vowel or silent h: le film qu'il a réalisé."],
        )
        l3 = Lesson.objects.create(
            topic=t, type="text", title="La culture française", order=3, difficulty=2, content={}
        )
        ReadingText.objects.create(
            lesson=l3,
            title="Paris, capitale culturelle",
            ...
            comprehension_questions=[
                ...
                {
                    "question": "Name two famous French writers mentioned in the text.",
                    "answer": "Any two from: Molière, Victor Hugo, Albert Camus.",
                },
            ],
        )
        self._bulk_questions(
            ...
            [
                (
                    "mcq",
                    "What is 'un chef-d'œuvre' in English?",
                    "a masterpiece",
                    ["a painting", "an exhibition", "an actor"],
                    "Chef-d'œuvre = masterpiece.",
                    2,
                ),
                (
                    "translate",
                    "Translate: 'The film that I watched was excellent.'",
                    "Le film que j'ai regardé était excellent.",
                    [],
                    "Use que as direct object relative pronoun.",
                    3,
                ),
                (
                    "fill_blank",
                    "C'est l'artiste ___ a peint ce tableau. (who)",
                    "qui",
                    ["que", "dont", "où"],
                    "Qui = who (subject).",
                    2,
                ...
                (
                    "mcq",
                    "Which relative pronoun replaces 'de + noun'?",
                    "dont",
                    ["qui", "que", "où"],
    ...
    def _seed_topic_18(self):
        ...
        l1 = Lesson.objects.create(
            ...
            order=1,
            difficulty=1,
            content={"intro": "Getting around the city in French."},
        )
        self._bulk_vocab(
            l1,
            [
                ...
                (
                    ...
                    "taxi",
                    "lə tak.si",
                    "Appelle un taxi, nous sommes en retard.",
                    "m",
                    "noun",
                ),
                (
                    ...
                    "train station",
                    "la ɡaʁ",
                    "Le train part de la gare Montparnasse.",
                    "f",
                    "noun",
                ),
                (
                    ...
                    "airport",
                    "la.e.ʁo.pɔʁ",
                    "L'aéroport Charles-de-Gaulle est le plus grand de France.",
                    "m",
                    "noun",
                ),
                (
                ...
                (
                    ...
                    "turn right",
                    "tuʁ.ne a dʁwat",
                    "Tournez à droite après le carrefour.",
                    "a",
                    "expression",
                ),
                (
                    ...
                    "go straight ahead",
                    "kɔ̃.ti.nɥe tu dʁwa",
                    "Continuez tout droit pendant 500 mètres.",
                    "a",
                    "expression",
                ),
                (
                    ...
                    "lə kaʁ.fœʁ",
                    "Traversez le carrefour et prenez la première rue.",
                    "m",
                    "noun",
                ),
                (
                ...
                (
                    ...
                    "va.li.de sɔ̃ titʁ də tʁɑ̃s.pɔʁ",
                    "N'oubliez pas de valider votre ticket.",
                    "a",
                    "expression",
                ),
                (
                    ...
                    "transfer/connection",
                    "la kɔ.ʁɛs.pɔ̃.dɑ̃s",
                    "Prenez la correspondance à Châtelet.",
                    "f",
                    "noun",
                ),
                (
        ...
        l2 = Lesson.objects.create(
            topic=t, type="grammar", title="The Imperative Mood", order=2, difficulty=2, content={}
        )
        GrammarRule.objects.create(
            lesson=l2,
            ...
            examples=[
                ...
                "Prenez la ligne 4 direction Montrouge.",
                "Ne traversez pas au feu rouge !",
                "Allons au musée ce weekend !",
        ...
        l3 = Lesson.objects.create(
            topic=t, type="text", title="Se déplacer à Paris", order=3, difficulty=2, content={}
        )
        ReadingText.objects.create(
            lesson=l3,
            title="Dans le métro parisien",
        ...
        self._bulk_questions(
            ...
            [
                (
                    ...
                    "Tournez à gauche",
                    ["Tournez à droite", "Continuez tout droit", "Traversez le carrefour"],
                    "À gauche = left.",
                    1,
                ),
                (
                    "translate",
                    "Translate: 'Take line 4 towards Montrouge.'",
                    "Prenez la ligne 4 direction Montrouge.",
                    [],
                    "Use the imperative prenez.",
                    2,
                ),
                (
                    "fill_blank",
                    "Ne ___ pas au feu rouge ! (traverser, imperative)",
                    "traversez",
                    ["traverse", "traversons", "traverser"],
                    "Negative imperative vous form = traversez.",
                    2,
                ),
                (
                    "mcq",
                    "What happens to -ER verbs in the tu imperative?",
                    "Drop the -s ending",
                    ["Add an accent", "Keep the -s", "Add -ez"],
                    "Parle! not Parles! for -ER verbs.",
                    2,
                ),
            ],
        )
    ...
    def _seed_topic_19(self):
        ...
        l1 = Lesson.objects.create(
            ...
            order=1,
            difficulty=1,
            content={"intro": "French cooking and gastronomy vocabulary."},
        )
        self._bulk_vocab(
            l1,
            [
                (
                    ...
                    "recipe",
                    "la ʁə.sɛt",
                    "As-tu la recette de la quiche lorraine ?",
                    "f",
                    "noun",
                ),
                (
                    ...
                    "ingredients",
                    "le.z ɛ̃.ɡʁe.djɑ̃",
                    "Vérifie que tu as tous les ingrédients.",
                    "m",
                    "noun",
                ),
                (
                    ...
                    "to cook (heat)",
                    "fɛʁ kɥiʁ",
                    "Faites cuire le poulet pendant une heure.",
                    "a",
                    "verb phrase",
                ),
                ...
                (
                    ...
                    "saucepan",
                    "la kas.ʁɔl",
                    "Mettez le lait dans la casserole.",
                    "f",
                    "noun",
                ),
                ...
                (
                    ...
                    "flour",
                    "la fa.ʁin",
                    "J'ai besoin d'un kilo de farine.",
                    "f",
                    "noun",
                ),
                ...
                (
                    ...
                    "cheese",
                    "lə fʁɔ.maʒ",
                    "La France produit plus de 300 fromages.",
                    "m",
                    "noun",
                ),
                (
                ...
                (
                    ...
                    "to taste",
                    "ɡu.te",
                    "Goûtez la sauce et ajoutez du sel si nécessaire.",
                    "a",
                    "verb",
                ),
                (
        ...
        l2 = Lesson.objects.create(
            topic=t, type="grammar", title="The Passive Voice", order=2, difficulty=3, content={}
        )
        GrammarRule.objects.create(
            lesson=l2,
            ...
            examples=[
                "Le coq au vin est préparé avec du vin rouge.",
                "La baguette a été inventée en France.",
                "Ce fromage est fabriqué en Normandie.",
                "Le repas sera servi dans dix minutes.",
                "La France est connue pour sa gastronomie.",
            ],
            exceptions=[
                "With on: 'On cuisine beaucoup en France' avoids the passive naturally in spoken French."
            ],
        )
        l3 = Lesson.objects.create(
            topic=t, type="text", title="Une recette française", order=3, difficulty=2, content={}
        )
        ReadingText.objects.create(
            lesson=l3,
            title="La recette du croque-monsieur",
        ...
        self._bulk_questions(
            ...
            [
                ...
                (
                    "translate",
                    "Translate: 'Preheat the oven to 180 degrees.'",
                    "Préchauffez le four à 180 degrés.",
                    [],
                    "Use imperative préchauffez.",
                    2,
                ),
                (
                    "fill_blank",
                    "Le pain ___ fabriqué chaque matin. (passive, present)",
                    "est",
                    ["a été", "sera", "était"],
                    "Present passive uses est + past participle.",
                    2,
                ),
                (
                    "mcq",
                    "How do you express the agent in a passive sentence?",
                    "par",
                    ["de", "avec", "pour"],
                    "The agent is introduced by par (by).",
                    2,
                ),
            ],
        )
    ...
    def _seed_topic_20(self):
        ...
        l1 = Lesson.objects.create(
            ...
            order=1,
            difficulty=2,
            content={"intro": "Vocabulary for discussing news and media."},
        )
        self._bulk_vocab(
            l1,
            [
                ...
                (
                    ...
                    "the news",
                    "le.z ɛ̃.fɔʁ.ma.sjɔ̃",
                    "Je regarde les informations à 20h.",
                    "f",
                    "noun",
                ),
                (
                    ...
                    "journalist",
                    "lə ʒuʁ.na.list",
                    "Elle est journaliste pour Le Monde.",
                    "m",
                    "noun",
                ),
                (
                ...
                (
                    ...
                    "front page",
                    "la yn",
                    "Cette affaire est à la une de tous les journaux.",
                    "f",
                    "noun",
                ),
                (
                    ...
                    "to broadcast",
                    "di.fy.ze",
                    "La chaîne a diffusé un reportage sur l'environnement.",
                    "a",
                    "verb",
                ),
                (
                    ...
                    "report/documentary",
                    "œ̃ ʁə.pɔʁ.taʒ",
                    "J'ai regardé un reportage sur la guerre.",
                    "m",
                    "noun",
                ),
                (
                    ...
                    "social media",
                    "le ʁe.zo sɔ.sjo",
                    "Les fausses nouvelles se répandent vite sur les réseaux sociaux.",
                    "m",
                    "noun",
                ),
                (
                    ...
                    "fake news",
                    "le fɛk njuz",
                    "Il faut vérifier les sources pour éviter les fake news.",
                    "f",
                    "noun",
                ),
                (
                    ...
                    "la li.bɛʁ.te də la pʁɛs",
                    "La liberté de la presse est essentielle en démocratie.",
                    "f",
                    "noun",
                ),
                (
                    ...
                    "debate",
                    "lə de.ba",
                    "Il y a eu un débat politique à la télévision.",
                    "m",
                    "noun",
                ),
                (
                    ...
                    "public opinion",
                    "lɔ.pi.njɔ̃ py.blik",
                    "L'opinion publique a changé sur ce sujet.",
                    "f",
                    "noun",
                ),
                (
                    ...
                    "to censor",
                    "sɑ̃.sy.ʁe",
                    "Ce gouvernement a censuré certains journalistes.",
                    "a",
                    "verb",
                ),
                (
                    ...
                    "podcast",
                    "lə pɔd.kast",
                    "J'écoute un podcast de français chaque matin.",
                    "m",
                    "noun",
                ),
                (
                    "objectif / objective",
                    "objective",
                    "ɔb.ʒɛk.tif / ɔb.ʒɛk.tiv",
                    "Un bon journaliste doit être objectif.",
                    "a",
                    "adjective",
                ),
            ],
        ...
        l2 = Lesson.objects.create(
            topic=t, type="grammar", title="The Subjunctive", order=2, difficulty=3, content={}
        )
        GrammarRule.objects.create(
            lesson=l2,
            ...
            examples=[
                "Il faut que tu lises les informations.",
                "Je suis content qu'il soit journaliste.",
                "Bien que la presse soit libre, certains pays censurent.",
                "Je doute que cette information soit vraie.",
                "Il est important que vous vérifiiez vos sources.",
            ],
            exceptions=[
                "No subjunctive needed when subjects are the same: Je veux partir (not Je veux que je parte)."
            ],
        )
        l3 = Lesson.objects.create(
            topic=t, type="text", title="Les médias en France", order=3, difficulty=3, content={}
        )
        ReadingText.objects.create(
            lesson=l3,
            title="L'ère de l'information",
            ...
            comprehension_questions=[
                {
                    "question": "Name two traditional French newspapers mentioned.",
                    "answer": "Le Monde and Le Figaro.",
                },
                {
                    "question": "What problem does social media create according to the text?",
                    "answer": "The spread of fake news (propagation des fake news).",
                },
            ],
        )
        self._bulk_questions(
            ...
            [
                (
                    "mcq",
                    "What is 'les informations' in English?",
                    "the news",
                    ["the articles", "the debates", "the podcasts"],
                    "Les informations / les infos = the news.",
                    1,
                ),
                (
                    "translate",
                    "Translate: 'It is important that you check your sources.'",
                    "Il est important que vous vérifiiez vos sources.",
                    [],
                    "Use subjunctive after il est important que.",
                    3,
                ),
                (
                    "fill_blank",
                    "Il faut que tu ___ les informations. (lire, subjunctive)",
                    "lises",
                    ["lis", "lisais", "lira"],
                    "Subjunctive of lire for tu = lises.",
                    3,
                ),
                (
                    "mcq",
                    ...
                    "Il faut que",
                    ["Je pense que", "Il dit que", "Je sais que"],
                    "Il faut que always requires the subjunctive.",
                    2,
                ),
            ],
        )
    ...
    def handle(self, *args, **options):
        self.stdout.write(
            self.style.MIGRATE_HEADING("Seeding extended French content (Topics 9-20)...")
        )
        self._seed_topic_9()
        self._seed_topic_10()
        self._seed_topic_11()
