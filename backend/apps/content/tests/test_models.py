...
class TestLessonModel:
    ...
    def test_lesson_ordering(self):
        ...
        Lesson.objects.create(
            topic=topic, type="vocab", title="Second", content={}, order=2, difficulty=1
        )
        Lesson.objects.create(
            topic=topic, type="vocab", title="First", content={}, order=1, difficulty=1
        )
    ...
    def test_lesson_cascade_delete(self):
        ...
        Lesson.objects.create(
            topic=topic, type="vocab", title="Lesson", content={}, order=1, difficulty=1
        )
        topic.delete()
...
class TestReadingTextModel:
    def test_create_reading_text(self):
        ...
        text = ReadingText.objects.create(
            ...
            comprehension_questions=[{"question": "Where does Marie go?", "answer": "A cafe"}],
        )
