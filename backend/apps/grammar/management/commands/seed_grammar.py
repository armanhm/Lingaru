...
CATEGORIES = [
    ...
    },
    {
        ...
        "icon": "👤",
        "order": 2,
        "description": "Subject, object, reflexive, and relative pronouns.",
    },
    {
        "slug": "articles",
        "name": "Articles",
    ...
    },
    {
        ...
        "icon": "🎭",
        "order": 5,
        "description": "Subjunctive, conditional, and imperative.",
    },
    {
        "slug": "structure",
        ...
        "icon": "🏗️",
        "order": 6,
        "description": "Word order, questions, and complex sentences.",
    },
]
...
TOPICS = [
        ...
        "common_mistakes": [
            {
                ...
                "note": "Aller uses être, not avoir.",
            },
        ],
        "drills": [
            {
                "type": "fill_blank",
                "prompt": "Hier, je _____ (manger) une pizza.",
                "correct_answer": "ai mangé",
            },
            {
                "type": "fill_blank",
                "prompt": "Tu _____ (finir) tes devoirs ?",
                "correct_answer": "as fini",
            },
            {
                "type": "fill_blank",
                "prompt": "Elle _____ (voir) ce film deux fois.",
                "correct_answer": "a vu",
            },
            {
                "type": "mcq",
                "prompt": "Choose: « Nous _____ acheté du pain. »",
                "options": ["avons", "sommes", "ont", "est"],
                "correct_answer": "avons",
            },
            {
                "type": "mcq",
                "prompt": "What is the past participle of « prendre »?",
                "options": ["pris", "prendu", "prené", "prit"],
                "correct_answer": "pris",
            },
            {
                "type": "mcq",
                "prompt": "What is the past participle of « écrire »?",
                "options": ["écrit", "écriu", "écrivé", "écrivi"],
                "correct_answer": "écrit",
            },
            {
                "type": "transform",
                "prompt": "Put in passé composé: « Je mange du chocolat. »",
                "correct_answer": "J'ai mangé du chocolat.",
            },
            {
                "type": "transform",
                "prompt": "Put in passé composé: « Tu finis le livre. »",
                "correct_answer": "Tu as fini le livre.",
            },
            {
                "type": "error_detect",
                "prompt": "Find the error: « Hier, j'ai allé au marché. »",
                "correct_answer": "ai allé",
                "explanation": "Aller takes être: je suis allé.",
            },
            {
                "type": "fill_blank",
                "prompt": "Ils _____ (faire) leurs devoirs ce matin.",
                "correct_answer": "ont fait",
            },
        ],
    },
    {
        ...
        "common_mistakes": [
            {
                "wrong": "Elle est allé.",
                "right": "Elle est allée.",
                "note": "Past participle agrees with feminine subject.",
            },
        ],
        "drills": [
            {
                "type": "fill_blank",
                "prompt": "Marie _____ (aller) au cinéma hier.",
                "correct_answer": "est allée",
            },
            {
                "type": "fill_blank",
                "prompt": "Les enfants _____ (rester) à la maison.",
                "correct_answer": "sont restés",
            },
            {
                "type": "fill_blank",
                "prompt": "Nous _____ (partir) à 8 heures.",
                "correct_answer": "sommes partis",
            },
            {
                "type": "mcq",
                "prompt": "Choose: « Sophie est _____ (arriver) à l'heure. »",
                "options": ["arrivée", "arrivé", "arrivés", "arrivant"],
                "correct_answer": "arrivée",
            },
            {
                "type": "mcq",
                "prompt": "Which verb takes être?",
                "options": ["aller", "manger", "regarder", "écouter"],
                "correct_answer": "aller",
            },
            {
                "type": "transform",
                "prompt": "Put in passé composé: « Elle vient avec nous. »",
                "correct_answer": "Elle est venue avec nous.",
            },
            {
                "type": "error_detect",
            ...
            {
                "type": "fill_blank",
                "prompt": "Mes amis _____ (venir) me voir.",
                "correct_answer": "sont venus",
            },
        ],
    },
    {
        ...
        "examples": [
            {
                "fr": "Quand j'étais petit, je jouais au foot.",
                "en": "When I was little, I played football.",
            },
        ...
        "common_mistakes": [
            {
                "wrong": "Je étais.",
                "right": "J'étais.",
                "note": "Always elide « je » before a vowel.",
            },
        ],
        "drills": [
            {
                "type": "fill_blank",
                "prompt": "Quand j'_____ (être) jeune, je jouais au tennis.",
                "correct_answer": "étais",
            },
            {
                "type": "fill_blank",
                "prompt": "Il _____ (faire) très chaud cet été-là.",
                "correct_answer": "faisait",
            },
            {
                "type": "fill_blank",
                "prompt": "Nous _____ (manger) toujours à 19h.",
                "correct_answer": "mangions",
            },
            {
                "type": "mcq",
                "prompt": "Choose the imparfait: « Elle _____ une belle robe. »",
                "options": ["portait", "porte", "a porté", "portera"],
                "correct_answer": "portait",
            },
            {
                "type": "mcq",
                "prompt": "When do you typically use the imparfait?",
                "options": [
                    "For habitual past actions",
                    "For finished single events",
                    "For future plans",
                    "For commands",
                ],
                "correct_answer": "For habitual past actions",
            },
            {
                "type": "transform",
                "prompt": "Put in imparfait: « Je mange du chocolat. »",
                "correct_answer": "Je mangeais du chocolat.",
            },
            {
                "type": "error_detect",
                "prompt": "Find the error: « Quand j'avais 10 ans, j'ai habité à Lyon. »",
                "correct_answer": "ai habité",
                "explanation": "Past habit needs imparfait: « j'habitais ».",
            },
    ...
    },
    {
        ...
        "drills": [
            {
                "type": "fill_blank",
                "prompt": "Demain, je _____ (parler) avec lui.",
                "correct_answer": "parlerai",
            },
            {
                "type": "fill_blank",
                "prompt": "Nous _____ (être) à Paris la semaine prochaine.",
                "correct_answer": "serons",
            },
            {
                "type": "fill_blank",
                "prompt": "Tu _____ (avoir) ton diplôme bientôt.",
                "correct_answer": "auras",
            },
            {
                "type": "mcq",
                "prompt": "Choose the futur simple: « Elle _____ chez nous. »",
                "options": ["viendra", "vient", "venait", "venir"],
                "correct_answer": "viendra",
            },
            {
                "type": "mcq",
                "prompt": "What's the futur simple stem of « faire »?",
                "options": ["fer-", "fais-", "faisi-", "faiss-"],
                "correct_answer": "fer-",
            },
            {
                "type": "transform",
                "prompt": "Put in futur simple: « Je vais au marché. »",
                "correct_answer": "J'irai au marché.",
            },
            {
                "type": "fill_blank",
                "prompt": "Ils _____ (pouvoir) le faire demain.",
                "correct_answer": "pourront",
            },
            {
                "type": "fill_blank",
                "prompt": "Vous _____ (voir) la différence.",
                "correct_answer": "verrez",
            },
        ],
    },
    # ── PRONOUNS ───────────────────────────────────────────────────
    {
        ...
        "examples": [
            {
                "fr": "Tu vois le chat ? Oui, je le vois.",
                "en": "Do you see the cat? Yes, I see it.",
            },
        ...
        "common_mistakes": [
            {
                "wrong": "Je vois le.",
                "right": "Je le vois.",
                "note": "Object pronoun goes BEFORE the verb.",
            },
        ],
        "drills": [
            {
                "type": "mcq",
                "prompt": "Replace: « Je regarde **le film**. »",
                "options": [
                    "Je le regarde.",
                    "Je la regarde.",
                    "Je les regarde.",
                ...
                "correct_answer": "Je le regarde.",
            },
            {
                "type": "mcq",
                "prompt": "Replace: « Tu connais **Marie** ? »",
                "options": [
                    "Tu la connais ?",
                    "Tu le connais ?",
                    "Tu lui connais ?",
                ...
                "correct_answer": "Tu la connais ?",
            },
            {
                "type": "fill_blank",
                "prompt": "Tu aimes les pommes ? Oui, je _____ aime.",
                "correct_answer": "les",
            },
            {
                "type": "fill_blank",
                "prompt": "Tu vois Paul ? Oui, je _____ vois.",
                "correct_answer": "le",
            },
            {
                "type": "transform",
                "prompt": "Use a pronoun: « J'écoute la radio. »",
                "correct_answer": "Je l'écoute.",
            },
            {
                "type": "error_detect",
                "prompt": "Find the error: « Je vois lui chaque jour. »",
                "correct_answer": "vois lui",
                "explanation": "Direct object: « Je le vois chaque jour. »",
            },
            {
                "type": "fill_blank",
                "prompt": "Tu prépares le dîner ? Oui, je _____ prépare.",
                "correct_answer": "le",
            },
            {
                "type": "mcq",
                "prompt": "Replace: « J'achète **les livres**. »",
                "options": ["Je les achète.", "Je l'achète.", "Je leur achète.", "J'en achète."],
                "correct_answer": "Je les achète.",
            },
        ],
    },
    {
        ...
        "examples": [
            ...
            {
                "fr": "Tu donnes le livre aux enfants ? → Tu leur donnes le livre ?",
                "en": "Are you giving the book to the kids? → Are you giving them the book?",
            },
        ],
        "exceptions": [],
        "common_mistakes": [
            {
                "wrong": "Je leurs parle.",
                "right": "Je leur parle.",
                "note": "« Leur » as a pronoun never takes -s.",
            },
            {
                "wrong": "Je le parle.",
                "right": "Je lui parle.",
                "note": "« Parler à » takes an indirect pronoun.",
            },
        ],
        "drills": [
            {
                "type": "mcq",
                "prompt": "Replace: « Je parle **à Paul**. »",
                "options": ["Je lui parle.", "Je le parle.", "Je leur parle.", "Je la parle."],
                "correct_answer": "Je lui parle.",
            },
            {
                "type": "mcq",
                "prompt": "Replace: « Elle écrit **à ses parents**. »",
                "options": [
                    "Elle leur écrit.",
                    "Elle leurs écrit.",
                    "Elle les écrit.",
                ...
                "correct_answer": "Elle leur écrit.",
            },
            {
                "type": "fill_blank",
                "prompt": "Je _____ téléphone tous les soirs (à ma mère).",
                "correct_answer": "lui",
            },
            {
                "type": "fill_blank",
                "prompt": "Tu _____ as donné le cadeau ? (aux enfants)",
                "correct_answer": "leur",
            },
            {
                "type": "error_detect",
                "prompt": "Find the error: « Je leurs ai parlé hier. »",
                "correct_answer": "leurs",
                "explanation": "Pronoun « leur » never takes an -s.",
            },
            {
                "type": "transform",
                "prompt": "Use a pronoun: « Il offre des fleurs à sa femme. »",
                "correct_answer": "Il lui offre des fleurs.",
            },
            {
                "type": "mcq",
                "prompt": "« Téléphoner » takes…",
                "options": ["a direct object", "an indirect object (à)", "no object", "either"],
                "correct_answer": "an indirect object (à)",
            },
            {
                "type": "fill_blank",
                "prompt": "Nous _____ avons écrit une lettre. (à nos amis)",
                "correct_answer": "leur",
            },
        ],
    },
    # ── ARTICLES ──────────────────────────────────────────────────
    {
        ...
        "drills": [
            {
                "type": "mcq",
                "prompt": "Choose: « ___ chat est noir. »",
                "options": ["Le", "La", "L'", "Les"],
                "correct_answer": "Le",
            },
            {
                "type": "mcq",
                "prompt": "Choose: « ___ étudiante travaille. »",
                "options": ["L'", "La", "Le", "Les"],
                "correct_answer": "L'",
            },
            {
                "type": "fill_blank",
                "prompt": "_____ enfants jouent au parc.",
                "correct_answer": "Les",
            },
            {
                "type": "fill_blank",
                "prompt": "J'aime _____ musique classique.",
                "correct_answer": "la",
            },
            {"type": "fill_blank", "prompt": "_____ amour est important.", "correct_answer": "L'"},
            {
                "type": "mcq",
                "prompt": "Which uses l'?",
                "options": ["l'hôtel", "le hibou", "la heure", "les amis"],
                "correct_answer": "l'hôtel",
            },
            {
                "type": "transform",
                "prompt": "Make plural: « le livre »",
                "correct_answer": "les livres",
            },
            {
                "type": "error_detect",
                "prompt": "Find the error: « Le école est grande. »",
                "correct_answer": "Le école",
                "explanation": "Should elide: « L'école ».",
            },
        ],
    },
    {
        ...
        "common_mistakes": [
            {
                ...
                "note": "After negation, « du/de la/des » → « de ».",
            },
        ],
        "drills": [
            {
                "type": "mcq",
                "prompt": "Choose: « Je voudrais ___ pain. »",
                "options": ["du", "de la", "des", "le"],
                "correct_answer": "du",
            },
            {
                "type": "mcq",
                "prompt": "Choose: « Tu bois ___ eau ? »",
                "options": ["de l'", "de la", "du", "des"],
                "correct_answer": "de l'",
            },
            {"type": "fill_blank", "prompt": "Elle achète _____ pommes.", "correct_answer": "des"},
            {
                "type": "fill_blank",
                "prompt": "Il y a _____ confiture sur la table.",
                "correct_answer": "de la",
            },
            {
                "type": "transform",
                "prompt": "Make negative: « Je mange du fromage. »",
                "correct_answer": "Je ne mange pas de fromage.",
            },
            {
                "type": "error_detect",
                "prompt": "Find the error: « J'ai beaucoup du temps. »",
                "correct_answer": "du",
                "explanation": "After « beaucoup », use « de »: beaucoup de temps.",
            },
            {
                "type": "fill_blank",
                "prompt": "Nous n'avons pas _____ argent.",
                "correct_answer": "d'",
            },
            {
                "type": "mcq",
                "prompt": "Choose: « Un kilo ___ pommes. »",
                "options": ["de", "des", "du", "le"],
                "correct_answer": "de",
            },
        ],
    },
    # ── NEGATION ──────────────────────────────────────────────────
    {
        ...
        "common_mistakes": [
            {
                "wrong": "Je pas mange.",
                "right": "Je ne mange pas.",
                "note": "Need both ne AND pas, around the verb.",
            },
        ],
        "drills": [
            {
            ...
            {
                "type": "transform",
                "prompt": "Negate: « Il aime le thé. »",
                "correct_answer": "Il n'aime pas le thé.",
            },
            {
                "type": "fill_blank",
                "prompt": "Je _____ comprends _____ .",
                "correct_answer": "ne, pas",
            },
            {
                "type": "mcq",
                "prompt": "Negate: « Nous mangeons. »",
                "options": [
                ...
                "correct_answer": "Nous ne mangeons pas.",
            },
            {
                "type": "transform",
                "prompt": "Negate: « J'ai mangé. »",
                "correct_answer": "Je n'ai pas mangé.",
            },
            {
                "type": "error_detect",
                "prompt": "Find the error: « Je ne mange. »",
                "correct_answer": "ne mange",
                "explanation": "Need « pas » after the verb: « Je ne mange pas. »",
            },
            {
                "type": "transform",
            ...
            {
                "type": "mcq",
                "prompt": "After negation, « du » becomes…",
                "options": ["de", "des", "le", "stays du"],
                "correct_answer": "de",
            },
        ],
    },
    # ── MOODS ─────────────────────────────────────────────────────
    {
        ...
        "common_mistakes": [
            {
                "wrong": "Il faut que tu fais.",
                "right": "Il faut que tu fasses.",
                "note": "« Il faut que » triggers subjunctive.",
            },
        ],
        "drills": [
            {
                "type": "fill_blank",
                "prompt": "Il faut que tu _____ (être) à l'heure.",
                "correct_answer": "sois",
            },
            {
                "type": "fill_blank",
                "prompt": "Je veux qu'il _____ (venir).",
                "correct_answer": "vienne",
            },
            {
                "type": "fill_blank",
                "prompt": "Il est important que nous _____ (faire) attention.",
                "correct_answer": "fassions",
            },
            {
                "type": "mcq",
                "prompt": "Choose: « Je doute qu'elle _____ raison. »",
                "options": ["ait", "a", "aura", "avait"],
                "correct_answer": "ait",
            },
            {
                "type": "mcq",
                "prompt": "Which expression triggers subjunctive?",
                "options": [
                    "il faut que",
                    "je sais que",
                    "je pense que (affirmative)",
                    "il est vrai que",
                ],
                "correct_answer": "il faut que",
            },
            {
                "type": "transform",
                "prompt": "Combine: « Il faut + tu pars maintenant. »",
                "correct_answer": "Il faut que tu partes maintenant.",
            },
            {
                "type": "error_detect",
                "prompt": "Find the error: « Je veux que tu vas au marché. »",
                "correct_answer": "vas",
                "explanation": "After « je veux que », subjunctive: « ailles ».",
            },
            {
                "type": "fill_blank",
                "prompt": "Je suis content que vous _____ (être) là.",
                "correct_answer": "soyez",
            },
        ],
    },
    # ── STRUCTURE ─────────────────────────────────────────────────
        ...
        "common_mistakes": [
            {
                "wrong": "A il fini ?",
                "right": "A-t-il fini ?",
                "note": "Add -t- between verb-vowel and il/elle.",
            },
        ],
        "drills": [
            {
                "type": "transform",
                "prompt": "Make a question with est-ce que: « Tu parles français. »",
                "correct_answer": "Est-ce que tu parles français ?",
            },
            {
                "type": "transform",
                "prompt": "Make a question with inversion: « Vous êtes français. »",
                "correct_answer": "Êtes-vous français ?",
            },
            {
                "type": "mcq",
                "prompt": "Which is correct?",
                "options": ["A-t-il mangé ?", "A il mangé ?", "A-il mangé ?", "Mangé-il a ?"],
                "correct_answer": "A-t-il mangé ?",
            },
            {
                "type": "fill_blank",
                "prompt": "_____ tu viens avec nous ?",
                "correct_answer": "Est-ce que",
            },
            {
                "type": "transform",
                "prompt": "Ask « when » formally: « Il arrive. »",
                "correct_answer": "Quand arrive-t-il ?",
            },
            {
                "type": "error_detect",
                "prompt": "Find the error: « Va il à Paris ? »",
                "correct_answer": "Va il",
                "explanation": "Need -t- and hyphens: « Va-t-il à Paris ? »",
            },
            {
                "type": "mcq",
                "prompt": "Most neutral way to ask?",
                "options": ["Est-ce que", "Inversion", "Intonation", "Question word alone"],
                "correct_answer": "Est-ce que",
            },
            {
                "type": "fill_blank",
                "prompt": "_____ -tu (vouloir) un café ?",
                "correct_answer": "Veux",
            },
        ],
    },
